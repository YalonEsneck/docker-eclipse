...
RUN curl --progress-bar 'https://ftp.halifax.rwth-aachen.de/eclipse/technology/epp/downloads/release/2019-09/R/eclipse-php-2019-09-R-linux-gtk-x86_64.tar.gz' | tar xzf - -C /opt
